...
object BiayaParkirObject {
    fun getBiayaParkir(): List <BiayaParkir> {
        return listOf(
            ...
            BiayaParkir(R.drawable.logo_factory_outlet, "Merdeka Factory Outlet", "Parkir motor RP2000", "Parkir mobil Rp4000"),
            BiayaParkir(R.drawable.logo_gramedia, "Gramedia Merdeka", "Parkir motor RP1500", "Parkir mobil Rp3000")
        )
    }
}